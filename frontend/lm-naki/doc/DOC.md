...
1. [Obecný popis a definice pojmů](#obecný-popis-a-definice-pojmů)
2. [Struktura uložených dat](#struktura-uložených-dat)
3. [Uživatelské role](#uživatelské-role)
4. [Typické scénáře použití aplikace](#typické-scénáře-použití-aplikace)
    1. [Vkládání nových dat](#vkládání-nových-dat)
    2. [Vyhledávání v datech](#vyhledávání-v-datech)
    3. [Vytvoření pohledu](#vytvoření-pohledu)
    4. [Vytváření struktury v datech](#vytváření-struktury-v-datech)
    5. [Definice odkazu a anotace](#definice-odkazu-a-anotace)
    6. [Export balíčku SIP](#export-balíčku-sip)
 5. [Postupy k jednotlivým scénářům](#postupy-k-jednotlivým-scénářům)
    ...
    2. [Vkládání nových dat](#vkládání-nových-dat)
       ...
       5. [Import metadat ze souboru](#import-metadat-ze-souboru)
    3. [Vyhledávání v databázi](#vyhledávání-v-databázi)
    4. [Vytvoření pohledu](#vytvoření-pohledu)
    5. [Vytvoření skupiny digitálních objektů](#vytvoření-skupiny-digitálních-objektů)
    6. [Vytvoření datové sady k představení](#vytvoření-datové-sady-k-představení)
    7. [Definice odkazu](#definice-odkazu)
    8. [Definice anotace v pohledu](#definice-anotace-v-pohledu)
    9. [Export balíčku SIP](#export-balíčku-sip)
    10. [Specifikace digitálních objektů pro export](#specifikace-digitálních-objektů-pro-export)
    11. [Export balíčku](#export-balíčku)
...
***
© 2018-2019 ČVUT FEL, Katedra počítačové grafiky a interakce
